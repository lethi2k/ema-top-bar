...
Donate link: https://www.ema4wp.com/
...
Bug reports (and Pull Requests) for [ZozoEMA Top Bar are welcomed on GitHub](https://github.com/ibericode/zozoema-top-bar). Please note that GitHub is _not_ a support forum.

**More information**

- [EMA4WP: ZozoEMA for WordPress](https://wordpress.org/plugins/zozoema-for-wp/)
- Developers; follow or contribute to the [ZozoEMA Top Bar plugin on GitHub](https://github.com/ibericode/zozoema-top-bar)
...
1. Set [your ZozoEMA API key](https://admin.zozoema.com/account/api) in **ZozoEMA for WP > ZozoEMA Settings**.
...
**KB:** [Add name field to ZozoEMA Top Bar](https://www.ema4wp.com/kb/add-name-field-to-zozoema-top-bar/)
...
Please report it on [GitHub issues](https://github.com/ibericode/zozoema-top-bar/issues) if it's not in the list of known issues.

= I have another question =

Please open a topic on the [WordPress.org plugin support forums](https://wordpress.org/support/plugin/zozoema-top-bar).


== Screenshots ==

1. The ZozoEMA Top Bar in action on the [ZozoEMA for WordPress site](https://www.ema4wp.com/#utm_source=wp-plugin-repo&utm_medium=zozoema-top-bar&utm_campaign=screenshots).
...
- Change name to EMA4WP: ZozoEMA Top Bar.
...
- Add ematb_after_submit_button action hook.
...
- Added `ematb_replace_interests` filter hook.
...
- Preparations for upcoming ZozoEMA for WordPress v4.0 release.

**Additions**

- Added Spanish language files, thanks to [Ángel Guzmán Maeso](http://shakaran.net/)
- Added `ematb_data` filter, to filter form data before it is processed.

**Deprecated**

- Deprecated `ematb_merge_vars` filter.
...
- Add support for new [debug log](https://www.ema4wp.com/kb/how-to-enable-log-debugging/) in ZozoEMA for WordPress 3.1
 ...
 **Additions**
 ...
 - Option to "update existing subscribers" in ZozoEMA, which is useful if you have added fields.
...
- Compatibility for [the upcoming ZozoEMA for WordPress 3.0 release](https://www.ema4wp.com/blog/breaking-backwards-compatibility-in-version-3-0/) tomorrow.
- Added `ematb_subscribed` filter.
...
- Added options for double opt-in and sending ZozoEMA's "welcome email".
- Added `ematb_before_label` action allowing you to add HTML before the label-element.
- Added `ematb_before_email_field` action allowing you to add HTML before the email field.
- Added `ematb_before_submit_button` action allowing you to add HTML before the submit button.
- Added `ematb_form_action` filter allowing you to set a custom form action.
...
- New filter: `ematb_zozoema_list` (set lists to subscribe to)
...
- Compatibility with [ZozoEMA for WordPress Lite v2.3](https://wordpress.org/plugins/zozoema-for-wp/) and [ZozoEMA for WordPress Pro v2.7](https://www.ema4wp.com/).

#### 1.0.7 - April 15, 2015

**Fixes**

- `ematb_show_bar` filter was not functioning properly with some themes.
...
- Bar will now show "already subscribed" message from ZozoEMA for WordPress when a person is already on the selected list.
...
- Top Bar sign-ups are now shown in the log for [ZozoEMA for WordPress Pro](https://www.ema4wp.com/).
...
- The menu item will now show above the item asking you to upgrade to ZozoEMA for WordPress Pro.

Please update the [ZozoEMA for WordPress plugin](https://wordpress.org/plugins/zozoema-for-wp/) before updating to this version.
