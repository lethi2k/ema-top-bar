...
function ematb_get_options()
{
    ...
    $defaults = array(
        ...
        'size' => 'medium',
        'sticky' => 1,
        'text_email_placeholder' => __( 'Your email address..', 'zozoema-top-bar' ),
        'text_bar' => __( 'Sign-up now - don\'t miss the fun!', 'zozoema-top-bar' ),
        'text_button' => __( 'Subscribe', 'zozoema-top-bar' ),
        'redirect' => '',
        'position' => 'top',
        'double_optin' => 1,
        'send_welcome' => 0,
    ...
    $options = (array) get_option('zozoema_top_bar', array());
    $options = array_merge( $defaults, $options );

    // for BC with ZozoEMA Top Bar v1.2.3, always fill text option keys
    $text_keys = array(
        'text_subscribed',
        'text_error',
        'text_invalid_email',
